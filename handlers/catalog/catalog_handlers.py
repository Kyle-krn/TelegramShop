...
from keyboards.inline import category_keyboard, start_catalog_keyboard, product_keyboard
...
async def category_handler(call: CallbackQuery):
    ...
    if category["children"]:
        ...
        await call.message.edit_text(text="Выберите товар", reply_markup=await product_keyboard(category))
